<?php
    ...
    $_lang['domains.desc']                                              = 'Beheer of wijzig domeinnamen voor meerdere contexten.';
    
    $_lang['area_domains']                                              = 'Domeinnamen';
    
    $_lang['setting_domains.branding_url']                              = 'Branding';
    $_lang['setting_domains.branding_url_desc']                         = 'De URL waar de branding knop heen verwijst, indien leeg wordt de branding knop niet getoond.';
    $_lang['setting_domains.branding_url_help']                         = 'Branding (help)';
    $_lang['setting_domains.branding_url_help_desc']                    = 'De URL waar de branding help knop heen verwijst, indien leeg wordt de branding help knop niet getoond.';
    ...
    $_lang['domains.domain_remove_confirm']                             = 'Weet je zeker dat je dit domeinnaam wilt verwijderen? Dit is permanent en onomkeerbaar.';
    ...
    $_lang['domains.primary_domain']                                    = 'Deze domeinnaam is het primaire domein voor deze context en overschrijft de fysieke context instellingen.';
    ...
    $_lang['domains.error_site_start_published']                        = 'De geselecteerd startpagina is niet gepubliceerd. Definieer een andere startpagina.';
    $_lang['domains.error_site_error']                                  = 'De geselecteerd 404 pagina bestaat niet. Definieer een andere 404 pagina.';
